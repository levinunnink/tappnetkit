...
extern NSString * const TKScopeEmail;
extern NSString * const TKScopeWritePost;
extern NSString * const TKScopeFollow;
extern NSString * const TKScopeMessages;
extern NSString * const TKScopeExport;

@interface TKAuthenticator : NSObject
